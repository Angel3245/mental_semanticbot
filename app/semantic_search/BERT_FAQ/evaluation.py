...
class Result:
    ...
    :param ndcg1: evaluation metric score NDCG@1
    :param ndcg3: evaluation metric score NDCG@3
    :param p1: evaluation metric score P@1
    ...
    def __init__(self, method="", match_field="", rank_field="", loss_type="", query_type="", neg_type="", 
                 ndcg1=0, ndcg3=0, p1=0, p3=0, _map=0):
    ...
    def __repr__(self):
        return {
            ...
            "NDCG@1"            : "{0:.2f}".format(self.ndcg1),
            "NDCG@3"            : "{0:.2f}".format(self.ndcg3),
            "P@1"               : "{0:.2f}".format(self.p1),
            "P@3"               : "{0:.2f}".format(self.p3),
            "MAP"               : "{0:.2f}".format(self._map)
        }
...
class Evaluation(object):
    ...
    :param rank_results_filepath: filepath to rank results
        file/data/MentalFAQ/rank_results         # MentalFAQ
    ...
    def __init__(self, qas_filename, rank_results_filepath, jc_threshold=1.0, test_data="synthetic", rankers=["unsupervised", "supervised"], 
                 ...
                 neg_types=["simple", "hard"], top_k=[1, 3]):
        ...
        for ranker in self.rankers:
            ...
            if ranker == "unsupervised":
                ...
                if self.test_data == 'synthetic':
                    ...
                    file_path = self.rank_results_filepath + "/" + ranker
                ...
                result = Result(method="unsupervised", match_field="answer", 
                    ndcg1=answer_metric[0], ndcg3=answer_metric[1], 
                    p1=answer_metric[2], p3=answer_metric[3], _map=answer_metric[4]
                )
                
                output['eval'][method + "_answer"] = result.__repr__()

                result = Result(method="unsupervised", match_field="question",
                    ndcg1=question_metric[0], ndcg3=question_metric[1], 
                    p1=question_metric[2], p3=question_metric[3], _map=question_metric[4]
                )
                
                output['eval'][method + "_question"] = result.__repr__()
                
                result = Result(method="unsupervised", match_field="question_answer",
                    ndcg1=question_answer_metric[0], ndcg3=question_answer_metric[1], 
                    p1=question_answer_metric[2], p3=question_answer_metric[3], _map=question_answer_metric[4]
                )
                
                output['eval'][method + "_question_answer"] = result.__repr__()
                            
                result = Result(method="unsupervised", match_field="question_answer_concat",
                    ndcg1=question_answer_concat_metric[0], ndcg3=question_answer_concat_metric[1], 
                    p1=question_answer_concat_metric[2], p3=question_answer_concat_metric[3],
                    _map=question_answer_concat_metric[4]
                )
                        ...
                        for query_type in self.query_types:
                            ...
                            for neg_type in self.neg_types:
                                ...
                                if self.test_data == 'synthetic':
                                    ...
                                    file_path = self.rank_results_filepath + "/" + ranker + "/" + rank_field + "/" + loss_type + "/" + query_type + "/" + neg_type
                                ...
                                if os.path.isdir(file_path):
                                    ...
                                    result = Result(
                                        ...
                                        ndcg1=question_answer_concat_metric[0], ndcg3=question_answer_concat_metric[1], 
                                        p1=question_answer_concat_metric[2], p3=question_answer_concat_metric[3], _map=question_answer_concat_metric[4]
                                    )
